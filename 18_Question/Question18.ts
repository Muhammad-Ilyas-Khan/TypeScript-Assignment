...
let favoritePlacesToVisit = ["Mauritius", "Rome", "Istanbul", "Paris", "Zurich", "Cairo", "Machu Picchu", "Barcelona"];

// print original order
    console.log("Original Order:", favoritePlacesToVisit);

// print alphabetical order without modifying
let alphabeticalOrder = favoritePlacesToVisit.slice().sort();
...
let reverseAlphabeticalOrder = favoritePlacesToVisit.slice().sort((a,b) => b.localeCompare(a));
...
favoritePlacesToVisit.sort((a, b) => b.localeCompare(a));
