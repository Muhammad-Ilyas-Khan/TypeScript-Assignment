...
var guesList = ["Albert Einstein", "William Shakespeare", "J.K.Rowling", "Pythagoras", "Charles Dickens", "George Orwell", " Emily Bronte", "Aristotle"];
console.log("Oops! The new dinner table won't arrive in time, and we can only invite two guests now.");
while (guesList.length > 2) {
    var removedGuests = guesList.pop();
...
for (var i = 0; i < guesList.length; i++) {
    console.log("Hello ".concat(guesList[i], ", you are still invited to the dinner."));
}
